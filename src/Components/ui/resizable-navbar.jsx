  ...
  return (
    <motion.div
      ...
      style={{
        minWidth: "1000px",      }} 
                           className={cn(
          "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl px-8 py-4 lg:flex dark:bg-black/10 dark:border-white/10", // Glass effect with backdrop-blur-xl, low opacity background, and border
          visible && "bg-white/20 dark:bg-black/20 backdrop-blur-2xl",
          className
        )}>
      {children}
    </motion.div>
    ...
    <motion.div
      ...
      transition={{
        ...
        damping: 50,
                           ...
                           className={cn(
          "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl px-0 py-2 lg:hidden dark:bg-black/10 dark:border-white/10",
          visible && "bg-white/20 dark:bg-black/20 backdrop-blur-2xl",
          className
        )}>
      {children}
